...
// interface RoleUpgradeFormProps {
//   availableRoles: AvailableRole[];
//   onRequestSubmitted?: () => void; // Add this optional prop for refresh callback
// }

// export function RoleUpgradeForm({ availableRoles, onRequestSubmitted }: RoleUpgradeFormProps) {
//   const [isSubmitting, setIsSubmitting] = useState(false);
//   const [formData, setFormData] = useState({
//     requestedRole: '',
//     justification: '',
...
//         // Refresh the requests list if callback provided
//         if (onRequestSubmitted) {
//           console.log('🔄 Calling refresh callback...');
//           onRequestSubmitted();
//         } else {
//           // Fallback: reload the page after a short delay to show the new request
